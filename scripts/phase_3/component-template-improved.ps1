...
# Example usage:
# New-Component -componentName "ShaderGenerator" -domainPath "src\domains\trait" -description "A component for generating and compiling shader code" -useEmotion
